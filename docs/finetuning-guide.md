...
**生成される内容:**
- 1,000枚の免許証風画像 × 8行 = 8,000行のテキスト画像
- 300種の名字 × 120種の名前 = 36,000通りの氏名パターン
- 全国約12万件の住所（KEN_ALL.CSV）からランダム選択
...
# → {"00000_0.png": "氏名 山田太郎", "00000_1.png": "生年月日 昭和20年3月15日生", ...}
```
...
|---|---|---|---|---|
| 行数 | 8,000行 | 80,000行 | 240,000行 | 400,000行 |
| 名字 | 300種 | 300種 | 300種 | 300種 |
| 名前 | 120種 | 120種 | 120種 | 120種 |
| 氏名パターン | 36,000通り | 36,000通り | 36,000通り | 36,000通り |
| 住所 | 約12万件 | 約12万件 | 約12万件 | 約12万件 |
| フォント | 最大10種類 | 最大10種類 | 最大10種類 | 最大10種類 |
| 漢字ブースト | なし | なし | 10,000枚追加 | 20,000枚追加 |
| Augmentation | 回転・ノイズ・ぼかし・JPEG劣化 | 同左 | 同左 | 同左 |
